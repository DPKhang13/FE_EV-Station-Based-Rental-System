            ...
            <div className="offers-container">
                ...
                <div id="4-seater-cars" className="offers-category">
                    ...
                    <div className="offers-grid">
                        ...
                        <div className="offer-card luxury">
                            ...
                            <p className="offer-price">Start from <span>$150</span> per month</p>
                            ...
                            <button
                                className="rent-now-button"
                                onClick={() => navigate('/booking/luxury-4seat')}
                            >
                                RENT NOW!
                            </button>
                        </div>
                ...
                <div className="offers-category">
                    ...
                    <div className="offers-grid">
                        ...
                        <div className="offer-card">
                            <img src="src/assets/7pro.jpg" alt="Pro" className="offer-image" />
                            <h3 className="offer-title">PRO</h3>
                        ...
                        <div className="offer-card">
                            <img src="src/assets/7proplus.jpg" alt="Pro Plus" className="offer-image" />
                            <h3 className="offer-title">PRO PLUS</h3>
                        ...
                        <div className="offer-card luxury">
                            <img src="src/assets/7luxury.jpg" alt="Luxury" className="offer-image" />
                            <h3 className="offer-title">LUXURY RENTALS</h3>
                            <p className="offer-price">Start from <span>$250</span> per month</p>
                            <p className="offer-description">Experience the ultimate luxury with our premium car rentals. Perfect for special occasions or high-end business needs!</p>
                            <button className="rent-now-button">RENT NOW!</button>
                        </div>
                    </div>
